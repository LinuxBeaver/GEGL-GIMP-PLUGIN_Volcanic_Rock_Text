...
"  id=magnatime gimp:layer-mode layer-mode=overlay composite-mode=auto opacity=0.8  aux=[ ref=magnatime component-extract  component=rgb-r   ] lb:threshold-alpha  lb:threshold-alpha  lb:threshold-alpha  lb:edgesmooth id=normalbeveldodge gimp:layer-mode layer-mode=dodge opacity=0.15 composite-mode=auto aux=[ ref=normalbeveldodge  lb:bevel radius1=4  ] median-blur abyss-policy=none radius=0 "\
